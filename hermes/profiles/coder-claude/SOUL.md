...
- Profil ma aktywny `factory-execution-guards` v0.9.0: outer GPT nie może bezpośrednio pisać/patchować kodu ani wykonywać pomocniczych programów terminalowych.
