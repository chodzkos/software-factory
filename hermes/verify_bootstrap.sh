...
grep -Fq 'dispatch-review --board <canonical-slug> --task-id <task-id>' "${RUNTIME_CONTROLLER_SOUL}"
grep -Fq 'dispatch-review --board <canonical-slug> --task-id <task-id>' "${ORCHESTRATOR_SOUL}"
...
grep -Fq 'HANDOFF_SCHEMA = 2' "${HANDOFF}"
